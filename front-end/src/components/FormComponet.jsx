...
const FormComponet = ({ handleInputChange, handleInputFocus, handleReset, cardData, setCards, cards }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setCards(cards.concat({ ...cardData, id: nanoid(6) })); // Agregar la tarjeta al estado
    handleReset();
    setErrorMessage("");
  };
